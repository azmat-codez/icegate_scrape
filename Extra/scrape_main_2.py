...
def get_captcha_text(image, angle):
    ...
    captcha_image_with_padding = ImageOps.expand(image, border=30, fill='white')

    image = captcha_image_with_padding.rotate(angle, expand=True, fillcolor='white')
